...
if (isset($email)){
   $sql = "SELECT PRODUCT.PRODID, PRODUCT.NAME, PRODUCT.PRICE, PRODUCT.QUANTITY, PRODUCT.WEIGHT, CART.CQUANTITY FROM PRODUCT INNER JOIN CART ON CART.PRODID = PRODUCT.PRODID WHERE CART.EMAIL = '$email'";
}
